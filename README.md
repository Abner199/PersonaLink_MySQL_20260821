...
当前稳定版本：[`v1.0.1`](https://github.com/Abner199/PersonaLink_MySQL_20260821/releases/tag/v1.0.1)。页面右下角和后端版本接口均可核对实际部署版本。

只下载稳定版：

```bash
git clone --branch v1.0.1 --single-branch https://github.com/Abner199/PersonaLink_MySQL_20260821.git
```
...
- 线上发现的低带宽照片墙超时问题已在 `v1.0.1` 修复；服务器需要升级到 `v1.0.1` 才会生效。
...
- v1.0.1 网络修复与服务器升级说明：[版本发布说明](./docs/releases/v1.0.1.md)
